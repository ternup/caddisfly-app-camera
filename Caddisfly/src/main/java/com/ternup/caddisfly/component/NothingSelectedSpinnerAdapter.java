...
public class NothingSelectedSpinnerAdapter implements SpinnerAdapter, ListAdapter {
     ...
     *
     * @param spinnerAdapter                wrapped Adapter. Should probably return false for
     *                                      isEnabled(0)
     ...
     */
    View getNothingSelectedView(ViewGroup parent) {
     ...
     * of these 37".
     */
    View getNothingSelectedDropdownView(ViewGroup parent) {
